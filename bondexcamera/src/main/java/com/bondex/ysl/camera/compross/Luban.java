...
public class Luban implements Handler.Callback {
    private static final String TAG = "bondex";
    private static final String DEFAULT_DISK_CACHE_DIR = "bondex_disk_cache";
    ...
    private List<File> get(Context context) {
    ...
    private File compressReal(Context context, InputStreamProvider path) {
        File result;

        File outFile = getImageCacheFile(context, mTargetDir);
